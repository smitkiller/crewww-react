...
const MaterialUiForm = props => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div>
        <Field name="firstName" id="firstName" component={renderTextField} label="First Name"/>
      </div>
      <div>
        <Field name="lastName" id="lastName" component={renderTextField} label="Last Name"/>
      </div>
      <div>
        <Field name="email" id="email" component={renderTextField} label="Email"/>
      </div>
      <div>
